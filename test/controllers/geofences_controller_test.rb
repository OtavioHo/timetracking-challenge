...
class GeofencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create geofence" do
    assert_difference('Geofence.count') do
      post geofences_url, params: { geofence: { latitude: @geofence.latitude, longitude: @geofence.longitude, radius: @geofence.radius } }
    end
  ...
  test "should update geofence" do
    patch geofence_url(@geofence), params: { geofence: { latitude: @geofence.latitude, longitude: @geofence.longitude, radius: @geofence.radius } }
